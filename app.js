/* ════════════════════════════════════════
       SVG character illustrations (one per class)
       ViewBox 120 × 160 – drawn with SVG primitives
    ════════════════════════════════════════ */
const SVG_CHARS = {
	/* ─── WARRIOR ─── heavy armour, sword & shield */
	warrior: `
	...
	/* ─── MAGE ─── tall robes, pointed hat, glowing staff */
	mage: `
        <svg viewBox="0 0 120 160" xmlns="http://www.w3.org/2000/svg">
          <defs>
	...
	/* ─── ROG (rogue) ─── dark hood, twin daggers, lean build */
	rog: `
        <svg viewBox="0 0 120 160" xmlns="http://www.w3.org/2000/svg">
          <defs>
	...
	/* ─── ROBBER ─── eye mask, money bag, casual clothes */
	robber: `
        <svg viewBox="0 0 120 160" xmlns="http://www.w3.org/2000/svg">
          <defs>
	...
	/* ─── CHILD ─── big head, small body, innocent look */
	child: `
        <svg viewBox="0 0 120 160" xmlns="http://www.w3.org/2000/svg">
          <defs>
